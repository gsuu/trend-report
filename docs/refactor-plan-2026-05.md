...
| **2차 (1~2주)** | 안건 3: 재발견 메타(`flow`,`brand_normalized`,`change_type`) + `/explore` | 안건 1 | 1주 | 누적 자산 활용도 | ✅ Done (2026-05-24) |
| | 안건 5: 퍼블리셔 분리 + `code_artifacts` + vite/11ty/Astro 소스 추가 | 안건 1 | 3일 | DEV 직군 가치 | ✅ Done (2026-05-24) |
| | 안건 2: discovery vs verification 등급 + 신규 소스 (디스콰이엇·유아이볼·GDWeb·Codrops·11ty/Astro) | 없음 | 1주 | 발견 폭 확장 | ✅ Done (2026-05-24) |
| **3차 (1개월)** | 안건 4: 다중 스크린샷 + 가로 갤러리 (글 단위; 가로 비교는 Explore 필터로 대체) | 안건 3, 안건 1 | 2주 | 디자이너 가치 폭발 | ✅ Done (2026-05-24) |
| | 안건 7-B: 앱스토어 RN 자동 수집 | 안건 7-A | 1주 | 신호 강도 1위 출처 확보 | ✅ Done (2026-05-24, 실제 호출 검증은 외부 환경에서) |
| | 안건 6-B: 채용 신호 `/signals` | 안건 2 | 1주 | PM 선행 지표 | ✅ Done (2026-05-24) |
| **4차 (운영)** | 안건 8: 일일 대시보드 | 위 전체 | 3일 | 운영자·클라이언트 단일 뷰 | ✅ Done (2026-05-24) |
