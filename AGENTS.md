...
1. **사례 정리** — 외부 브랜드·서비스에서 무엇이 일어났는가
2. **클라이언트 적용 가설** — 우리가 어떤 종류의 클라이언트에게 어떤 방식으로 가져갈 수 있는가
3. **점검 질문** — 클라이언트 회의에서 우리가 던질 한 문장 질문

이 시스템 가정은 [article-content-redesign-v2-agency-2026-05.md](docs/article-content-redesign-v2-agency-2026-05.md) 4번째 회의에서 확정됐다. 이전 1·2·3번 회의록의 어조 중 "우리 서비스"로 적힌 부분은 모두 "클라이언트 적용"으로 재해석한다.
