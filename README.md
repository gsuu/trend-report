...
10. `scripts/tracking/fill_missing_images.py collections/YYYY-MM-DD-raw-trend-collection.md`로 원천 수집 파일의 빈 이미지를 먼저 보강합니다.
11. `scripts/legacy/new_report.py`로 이번 주 리포트 파일을 생성합니다.
...
14. `scripts/tracking/fill_missing_images.py reports/YYYY-MM-DD-uiux-web-service-weekly-trend-report.md`를 실행해 새 아티클 이미지 누락을 한 번 더 막습니다.
